<template>
    ...
    <div>
        <Jumbotron buttonUrl="#" buttonText="Tovább a kérdőivekre!">
            <template slot="title">
                Mug, aftertaste cappuccino.
            </template>
            <template slot="lead">
                Mug, aftertaste cappuccino, coffee trifecta variety half and half aftertaste.
                Viennese redeye carajillo so iced sit foam. Brewed id a decaffeinated, cultivar
                filter percolator french press filter crema dripper.
            </template>
        </Jumbotron>
        ...
        <main>
            ...
            <YoutubeVideoEmbed
                    title="Videó beágyazása a weboldalba"
                    videoSource="https://www.youtube.com/embed/FiCtolh3hX4?list=PL4cUxeGkcC9g_69kOfXICzT_hZ79_td99">
            </YoutubeVideoEmbed>
...
<script>
import Jumbotron from "../componenets/Jumbotron.vue";
import YoutubeVideoEmbed from "../componenets/YoutubeVideoEmbed.vue";
export default {
    components: {YoutubeVideoEmbed, Jumbotron}
};
</script>